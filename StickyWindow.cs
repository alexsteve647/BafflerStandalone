...
namespace BafflerStandalone
{
	public class StickyWindow : NativeWindow
	{
		...
		protected override void OnHandleChange()
		{
			...
			{
				StickyWindow.GlobalStickyWindows.Add(this.originalForm);
				return;
			}
			StickyWindow.GlobalStickyWindows.Remove(this.originalForm);
		}
